<div>
    <div wire:ignore.self class="modal fade" id="editBorrowerModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <form wire:submit.prevent="update">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Note: Please enter exactly 10 digits/character for
                                the
                                Student ID.
                            </small>
                            @error('student_id')
